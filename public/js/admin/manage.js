...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_js_toggle_button__ = __webpack_require__(47);
...
var Avatar = __webpack_require__(48);
...
new Vue({
    ...
    methods: {
        ...
        avatarSelected: function avatarSelected($ev) {
            var file = $ev.target.files[0];
            var reader = new FileReader();
            reader.addEventListener('load', this.showAvatarCropper);
            reader.readAsDataURL(file);
        },
        showAvatarCropper: function showAvatarCropper(e) {
            var _this = this;
            ...
            swal({
                ...
                if (response && _this.croppie != null) {
                    _this.croppie.result('blob').then(_this.submitAvatar);
                }
            });

            setTimeout(function () {
                _this.croppie = new Croppie(img, {
                    viewport: {
                        width: 120,
                        height: 120,
                        type: 'square'
        ...
        submitAvatar: function submitAvatar(blob) {
            var data = new FormData();
            data.append('avatar', blob);

            axios.post(document.querySelector('input[name="avatar"]').getAttribute('data-url'), data).then(function (response) {
                if (response) {
