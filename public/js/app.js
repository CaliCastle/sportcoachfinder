...
var app = new Vue({
    ...
    methods: {
        toggleUserProfileDropdown: function toggleUserProfileDropdown() {
            var force = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;

            var profileEl = this.$el.querySelector('.ui-navigation-bar__user');
        ...
        bodyClicked: function bodyClicked(e) {
            var hasClosestProfileDropdown = e.target.closest('.ui-navigation-bar__user');
