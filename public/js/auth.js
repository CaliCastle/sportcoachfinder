...
Vue.component('loader', __webpack_require__(39));
    ...
    methods: {
        submitForm: function submitForm() {
            ...
            axios({
                ...
                setTimeout(function () {
                    return _this.focusConfirmationCodeInput();
                }, 550);
        ...
        * */
        login: function login() {
            ...
            if (this.registering) {
                ...
                setTimeout(function () {
                    return _this2.$form.querySelector('input[name=email]').focus();
                }, 500);
        ...
        register: function register() {
            ...
            if (!this.registering) {
                ...
                setTimeout(function () {
                    return _this3.$form.querySelector('input[name=name]').focus();
                }, 500);
        ...
        submitConfirmationCode: function submitConfirmationCode() {
            ...
            axios({
                ...
                setTimeout(function () {
                    if (_this4.redirectTo != null) {
                        window.location.href = _this4.redirectTo;
                    }
                }, 100);
            }).catch(function (error) {
                var response = error.response;
                ...
                _this4.toggleFormLoading(form, false);
            });
        },
        resendConfirmationCode: function resendConfirmationCode() {
            ...
            axios({
                ...
                _this5.resendingConfirmation = false;
