...
var render = function() {
  ...
  return _c(
    "div",
    {
      ...
      staticClass: "form-loader line-scale-pulse-out-rapid",
...
Vue.component('loader', __webpack_require__(32));
...
var app = new Vue({
    ...
    data: function data() {
        return {
            ...
            datepicker: null,
            confirmCodes: [null, null, null, null, null, null],
    ...
    computed: {
        ...
        validConfirmationCode: function validConfirmationCode() {
            return this.confirmCodes.filter(function (code) {
                return code != null && /^[0-9]*$/.test(code) && code !== '';
            }).length == this.confirmCodes.length;
        },
        confirmationCode: function confirmationCode() {
            return this.confirmCodes.join('');
        }
    },
    methods: {
        autofillZipcode: function autofillZipcode() {
            ...
            var input = document.querySelector('input[name="zipcode"]');
            postalCodeLookup(input);
        },
        submitInfo: function submitInfo() {},
        completeAndRedirect: function completeAndRedirect() {
            var _this = this;
        ...
        submitForm: function submitForm() {
            ...
            axios({
                ...
                if (redirect != null) {
                    _this2.redirectTo = redirect;
                }

                if (!_this2.registering) {
                    window.location.href = redirect;
                    return;
                }

                // Confirmation code
                _this2.confirming = true;

                setTimeout(function () {
                    return _this2.focusConfirmationCodeInput();
                }, 550);
                ...
                _this2.toggleFormLoading(form, false);
            });
        },
        ...
        * */
        login: function login() {
            ...
            if (this.registering) {
                ...
                setTimeout(function () {
                    return _this3.$form.querySelector('input[name=email]').focus();
                }, 500);
        ...
        register: function register() {
            ...
            if (!this.registering) {
                ...
                setTimeout(function () {
                    return _this4.$form.querySelector('input[name=firstName]').focus();
                }, 500);
        ...
        checkFormLoading: function checkFormLoading(e) {
            console.log(e);
        ...
        focusConfirmationCodeInput: function focusConfirmationCodeInput() {
            document.querySelector('.confirmation-inputs input').focus();
        },
        confirmCodeEntered: function confirmCodeEntered(e) {
            switch (e.key) {
                case "0":
                case "1":
                case "2":
                ...
                case "8":
                case "9":
                    var currentIndex = e.target.id.substring(5);
                    var nextInput = document.querySelector('.confirmation-input #code-' + (Number.parseInt(currentIndex) + 1));
        ...
        deleteConfirmCode: function deleteConfirmCode(e) {
            var current = e.target.id.substring(5);
            var previousInput = document.querySelector('.confirmation-input #code-' + (Number.parseInt(current) - 1));

            if (previousInput != null) {
                previousInput.focus();
            }
        },
        submitConfirmationCode: function submitConfirmationCode() {
            var _this5 = this;
            ...
            var form = document.querySelector('.auth__form--confirm');
            ...
            axios({
                ...
                if (response && response.data.status == "success") {
                    _this5.confirming = false;
                    _this5.enteringInfo = true;

                    setTimeout(function () {
                        return _this5.autofillZipcode();
                    }, 300);
                } else {
                    showServerError();
                }
                ...
                _this5.toggleFormLoading(form, false);
            });
        },
        resendConfirmationCode: function resendConfirmationCode() {
            ...
            axios({
                ...
                _this6.resendingConfirmation = false;
                _this6.toggleFormLoading(form, false);
            });
        },
        passwordReset: function passwordReset(e) {
            var _this7 = this;

            this.errors = [];

            var form = e.target.closest('form.auth__form');
            ...
            axios({
                ...
                _this7.toggleFormLoading(form, false);
            });
        },
        completePasswordReset: function completePasswordReset(e) {
            var _this8 = this;
            ...
            axios({
                ...
                _this8.toggleFormLoading(form, false);
            });
        }
    }
});
